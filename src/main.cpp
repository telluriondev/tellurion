...
const string strMessageMagic = "Tellurion Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees, uint256 prevHash)
{
    ...
    int rand = generateMTRandom(seed, 3504);
	if (nHeight <= 10)
        nSubsidy = 0;
	else if (nHeight <= 253)
        nSubsidy = 622632 * COIN;
    else if (nHeight <= LAST_POW_BLOCK)
        nSubsidy = (96 + rand) * COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Tellurion", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "TELLURION started 27.08.2016";
        CTransaction txNew;
        txNew.nTime = 1472272432;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1472272432;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 26018 : 26018;
...
//        assert(block.hashMerkleRoot == uint256("0xeb42ae0324ea968b5cdcd959104fc3b1cd93c45e25ba5be25b5e55deaf21254c"));
        assert(block.hashMerkleRoot == uint256("0x61e3087c9795eeb153510c5eded4a1b010e2bedb3441a784227807c721829d4d"));
    ...
    string strPubKey = "04037a8c9f7c9a546fc61cd1a9cad0467d89ff3a85b8882787fafaf3fe21f2f748b8dc37de90a0d125583d90d0af01a6d84f655a97b605276a2a4c0919ace50ec5";
...
unsigned char pchMessageStart[4] = { 0x1a, 0x1c, 0x3a, 0x1b };
