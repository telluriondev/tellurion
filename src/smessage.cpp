...
// Copyright (c) 2015 The Tellurion developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("tellurion-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("tellurion-smsg-pow"); // Make this thread recognisable
